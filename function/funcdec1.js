"use strict"; //this should be declared on line first itself to avoid the uncaughtReference error, 
// so here you need to define the firstName as var firstName and below same
